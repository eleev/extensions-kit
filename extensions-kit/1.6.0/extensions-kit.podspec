#
#  Be sure to run `pod spec lint extensions-kit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "1.6.0"
  s.summary      = "📦 A collection of extensions for Swift Programming Language -> 1️⃣6️⃣0️⃣ extensions + 1️⃣8️⃣ custom types."
