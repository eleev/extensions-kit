...
extension SKSpriteNode {
    ...
    public convenience init(withAnimatedGif name: String, correctAspectRatioFor width: CGFloat) {
    ...
    public func animateWithLocalAspectCorrectGIF(named name: String, width: CGFloat) {
    ...
    @discardableResult
    public func animateWithLocalGIF(named name: String) -> CGSize? {
    ...
    private class func gcdFor(pair value: Int, target: Int) -> Int {
        var a = value
        var b = target
