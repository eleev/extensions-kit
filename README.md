...
🎉 Collection of Swift extensions(+ custom types) for various use cases. The kit contains **`111`** extensions + **`7`** custom types. Feel free to contribute something new and amazing. 
